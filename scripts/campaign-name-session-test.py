...
def main():
    ...
    r, calls = run(["w1:p1", "campaign-1-planner-1", "w1:p1", "campaign-1-executor-3"])
    ...
    r, calls = run(["w1:p1", "campaign-1-executor-3"], list_fails=True)
    ...
    r, calls = run(["w1:p1", "campaign-1-executor-3"], agents=idle[:0])
    ...
    r, calls = run(["w1:p1", "campaign-1-executor-3", "w1:p2", "campaign-1-planner-4"],
                   agents=two)
