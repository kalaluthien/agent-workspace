 ...
 *   R1h_UnboundMachineStillLoses     SAT   BOUND is a rule, not a lock
 *   R1p_BoundAloneStillLoses         SAT   the membership rule never serialized
 *                                          the body
 ...
 *                                          the repair is agent.als's A10-A12
