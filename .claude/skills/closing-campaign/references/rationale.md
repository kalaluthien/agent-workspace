...
`runtime/claims/` have no other home (#52, "Holding scaffolds"). The
...
`<campaign>/runtime/claims/`, and both need a directory that did not exist —
...
`campaign-<N>-` finds the delegates and misses exactly what `runtime/claims/`
